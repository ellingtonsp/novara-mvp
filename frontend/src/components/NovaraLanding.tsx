...
const NovaraLanding = () => {
      ...
      <>
        ...
        {showLogin && (
          <div className="fixed inset-0 bg-black/50 flex items-end justify-center p-0 z-50">
            <Card className="w-full max-w-md rounded-t-2xl rounded-b-none animate-slide-up">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-xl bg-gradient-to-r from-[#FF6F61] to-[#CBA7FF] bg-clip-text text-transparent">
                    Welcome Back
                  </CardTitle>
                  <button
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-2 h-12 text-base border-[#FF6F61]/30 focus:border-[#FF6F61]"
                    />
                  </div>
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <Button
                      ...
                      className="flex-1 h-12 bg-[#FF6F61] hover:bg-[#FF6F61]/90 text-white"
                    >
        ...
        {/* Signup Form Modal - Mobile Optimized */}
        {showForm && (
          <div className="fixed inset-0 bg-black/50 flex items-end justify-center p-0 z-50">
            <Card className="w-full max-w-md h-5/6 overflow-y-auto rounded-t-2xl rounded-b-none">
              ...
              <CardContent className="pb-8">
                <div className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      <Label htmlFor="nickname" className="text-sm font-medium">What should we call you?</Label>
                      <Input
                        id="nickname"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select onValueChange={(value) => handleInputChange('cycle_stage', value)}>
                        <SelectTrigger className="mt-2 h-12 text-base border-[#FF6F61]/30 focus:border-[#FF6F61]">
                    ...
                    <div>
                      <Label className="text-sm font-medium">What would be most helpful right now?</Label>
                  ...
                  <div className="space-y-6 bg-gray-50 p-4 rounded-xl">
                    ...
                    <div>
                      <Label className="text-sm font-medium text-gray-700 mb-3 block">
                        IVF medications: {formData.confidence_meds}/10
                      </Label>
                      <input
                        type="range"
                        min="1"
                        ...
                        className="w-full h-3 bg-gray-200 rounded-lg appearance-none cursor-pointer slider-coral"
                      />
                    </div>

                    <div>
                      <Label className="text-sm font-medium text-gray-700 mb-3 block">
                        Cost management: {formData.confidence_costs}/10
                      </Label>
                      <input
                        type="range"
                        min="1"
                    ...
                    <div>
                      <Label className="text-sm font-medium text-gray-700 mb-3 block">
                        Overall journey: {formData.confidence_overall}/10
                      </Label>
                      <input
                        type="range"
                        min="1"
                  ...
                  <div>
                    <Label htmlFor="top_concern" className="text-sm font-medium">What's your biggest concern right now? (Optional)</Label>
                    <Textarea
                      id="top_concern"
                      value={formData.top_concern}
                      onChange={(e) => handleInputChange('top_concern', e.target.value)}
                      placeholder="Share what's on your mind..."
                      className="mt-2 border-[#FF6F61]/30 focus:border-[#FF6F61] resize-none text-base"
                      rows={3}
                    />
                  </div>

                  <div className="flex items-start space-x-3 p-4 bg-[#FFF5F0]/50 rounded-lg">
                    <input
                      type="checkbox"
                      id="email_opt_in"
                      checked={formData.email_opt_in}
                      onChange={(e) => handleInputChange('email_opt_in', e.target.checked)}
                      className="mt-1 h-5 w-5 text-[#FF6F61] bg-gray-100 border-gray-300 rounded focus:ring-[#FF6F61] focus:ring-2"
                    />
  ...
  // Authenticated User Mobile Views
  return (
