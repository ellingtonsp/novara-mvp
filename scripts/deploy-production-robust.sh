...
echo "🚀 Novara Production Deployment - Robust Mode"
echo "============================================="
...
DEPLOY_LOG="/tmp/railway_deploy_$(date +%s).log"
...
HEALTH_RESPONSE=$(curl -s -m 30 https://novara-mvp-production.up.railway.app/api/health || echo "FAILED")
...
ANALYTICS_RESPONSE=$(curl -s -m 30 -X POST https://novara-mvp-production.up.railway.app/api/analytics/events \
...
log "🌐 Production URL: https://novara-mvp-production.up.railway.app"
log "📊 Health: https://novara-mvp-production.up.railway.app/api/health"
